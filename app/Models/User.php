 ...
 * @property string|null $company_catch_phrase
 * @property string|null $company_bs
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|User whereSuite($value)
...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'source_id', 'username', 'phone', 'website', 'street',
        'suite', 'city', 'zipcode', 'lat', 'lng', 'company_name', 'company_catch_phrase', 'company_bs'
    ];
     ...
     * @return User|Model
     */
    public function make(array $attributes): Model|User
    {
